	          ...
	          <div id="container">
	          	<div class="row justify-content-center">
		            ...
		            <form style="margin: 2rem;" action="" method="post">
			                ...
			                <!-- This is for the raffle event name -->
			                <div class="form-row">
			                  <div class="form-group col-md-10">
			                    <label for="eventName" style="font-size: 24px;"><strong>Event Name</strong></label>
			                    <input type="text" class="form-control" required name="event_name" value="<?php echo $raffle['raffle_event_name'] ?>" placeholder="Event Name" style="width: 33rem;">
			                  </div>
			                </div>
			                ...
			                <div class="form-row">
			                  <div class="form-group col-md-10">
			                    <label for="mechanics" style="font-size: 24px;"><strong>Mechanics</label>
			                    <textarea class="form-control rounded-0" required name="mechanics" rows="3" style="width: 33rem;"> <?php echo $raffle['raffle_mechanics'] ?></textarea>
			                  </div>
			                </div>
						   ...
						   <div class="form-row">
			                  <div class="form-group col-md-10">
			                    <label for="eventName" style="font-size: 24px;">Deadline</label><br>
			                ...
			                <!-- This is where the prizes will be added. -->
